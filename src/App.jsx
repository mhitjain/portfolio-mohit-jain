...
import { Github, Linkedin, Mail, ExternalLink, Code2, Sparkles, Terminal, Briefcase, Award, ChevronRight, Cpu, Database, Rocket, Camera, Trophy, Target } from 'lucide-react';
...
export default function Portfolio() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 text-white overflow-hidden relative">
      ...
      <div 
        className="fixed w-96 h-96 rounded-full bg-gradient-to-r from-blue-500/20 to-purple-500/20 blur-3xl pointer-events-none transition-all duration-300 ease-out z-0"
        style={{
      ...
      {codeSnippets.map((snippet, idx) => (
        <div
          key={idx}
          className="absolute text-blue-300 font-mono text-base md:text-lg animate-float pointer-events-none select-none hidden md:block font-bold tracking-wide"
          style={{
            left: `${snippet.x}%`,
            top: `${snippet.y}%`,
      ...
      {/* Decorative grid */}
      <div className="fixed inset-0 bg-[linear-gradient(rgba(255,255,255,.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,.02)_1px,transparent_1px)] bg-[size:100px_100px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_50%,black,transparent)] pointer-events-none" />
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 z-10">
        <div className="max-w-6xl w-full flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="relative group">
            ...
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-slate-800 bg-gradient-to-br from-blue-900 to-purple-900">
              <img 
                src="/mohit.jpeg" 
                alt="Mohit" 
          ...
          <div className="flex-1">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/30 rounded-full mb-8 backdrop-blur-sm animate-fade-in">
              <Sparkles className="w-4 h-4 text-blue-400 animate-pulse" />
              <span className="text-sm text-blue-300">Available for Full Stack Developer & AI Engineer roles</span>
            </div>
            
            <h1 className="text-6xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-white via-blue-100 to-purple-200 bg-clip-text text-transparent animate-fade-in">
              Mohit Jain
            </h1>
            
            <p className="text-2xl md:text-3xl text-blue-200 mb-4 animate-fade-in animation-delay-200">
              AI Engineer & Full-Stack Developer
            </p>
            
            <div className="text-xl text-emerald-300 mb-6 font-mono h-8 animate-fade-in animation-delay-300">
              {typedText}
            </div>
            
            <p className="text-lg text-slate-300 max-w-2xl mb-8 leading-relaxed animate-fade-in animation-delay-400">
            ...
            <div className="flex flex-wrap gap-4 mb-8 animate-fade-in animation-delay-500">
              <a href="#contact" className="group flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg hover:shadow-xl hover:shadow-blue-500/50 transition-all duration-300 hover:scale-105">
                <Mail className="w-5 h-5" />
                Get in Touch
                <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </a>
              <a href="https://github.com/mhitjain/resume/blob/f159530623e2d4f66d1386f70e08be50d5b64e22/Mohit%20Jain.pdf" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 px-6 py-3 border border-slate-600 rounded-lg hover:border-blue-500 hover:bg-blue-500/10 transition-all duration-300 backdrop-blur-sm">
                <ExternalLink className="w-5 h-5" />
                Download Resume
              </a>
              <a href="#projects" className="flex items-center gap-2 px-6 py-3 border border-slate-600 rounded-lg hover:border-purple-500 hover:bg-purple-500/10 transition-all duration-300 backdrop-blur-sm">
            ...
            <div className="flex gap-6 animate-fade-in animation-delay-600">
              <a href="https://github.com/mhitjain" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-400 transition-all duration-300 hover:scale-125 transform">
                <Github className="w-6 h-6" />
              </a>
              <a href="https://linkedin.com/in/mohit-jain-3008" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-blue-400 transition-all duration-300 hover:scale-125 transform">
                <Linkedin className="w-6 h-6" />
              </a>
              <a href="mailto:mohitjain3099@gmail.com" className="text-slate-400 hover:text-blue-400 transition-all duration-300 hover:scale-125 transform">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            {experience.map((exp, idx) => (
              <div key={idx} className="group relative bg-gradient-to-br from-slate-900/80 to-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 hover:border-blue-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20 hover:-translate-y-1">
                ...
                <div className="relative">
                  <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-2">
                    <div>
                      <h3 className="text-2xl font-bold text-blue-300 mb-1 group-hover:text-blue-200 transition-colors">
                        {exp.role}
                      </h3>
                      <p className="text-xl text-slate-300">{exp.company}</p>
                      {exp.location && (
                        <p className="text-sm text-slate-400 mt-1">{exp.location}</p>
                      )}
                    </div>
                  ...
                  {exp.technologies && (
                    <div className="flex flex-wrap gap-2 pt-4 border-t border-slate-700/50">
                      {exp.technologies.map((tech, i) => (
                        <span key={i} className="px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-md text-xs text-blue-300 font-mono">
                          {tech}
                        </span>
                      ))}
                    </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {projects.map((project, idx) => (
              <div 
                ...
                className="group relative bg-gradient-to-br from-slate-900/80 to-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 hover:border-transparent transition-all duration-500 hover:shadow-2xl hover:-translate-y-2 overflow-hidden cursor-pointer"
              >
                ...
                <div className="relative">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <ExternalLink className="w-5 h-5 text-slate-500 group-hover:text-blue-400 transition-colors group-hover:rotate-45 duration-300" />
                  </div>
                  
                  <h3 className="text-xl font-bold text-blue-300 group-hover:text-blue-200 transition-colors mb-3">
                    {project.title}
                  </h3>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech, i) => (
                      <span key={i} className="px-3 py-1 bg-blue-500/10 border border-blue-500/30 rounded-full text-xs text-blue-300 hover:bg-blue-500/20 transition-all duration-300">
                        {tech}
                      </span>
                    ))}
                  </div>
      ...
      <section className="py-20 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Terminal Window */}
          <div className="bg-gradient-to-br from-slate-950 to-slate-900 rounded-2xl overflow-hidden border border-slate-700/50 shadow-2xl">
            {/* Terminal Header */}
            <div className="bg-slate-800/80 px-4 py-3 flex items-center gap-2 border-b border-slate-700/50">
              ...
              <span className="text-slate-400 text-sm ml-4 font-mono">skills.sh - bash</span>
            </div>
            ...
            <div className="p-6 font-mono text-sm space-y-6">
              {Object.entries(skills).map(([category, items], idx) => (
                <div key={idx} className="animate-fade-in" style={{animationDelay: `${idx * 0.1}s`}}>
                  ...
                  {/* Output */}
                  <div className="ml-4 pl-4 border-l-2 border-slate-700/50">
                    <div className="flex flex-wrap gap-2">
                      {items.map((skill, i) => (
                        <span 
                          key={i} 
                          className="group relative px-3 py-1.5 bg-slate-800/60 border border-slate-600/40 rounded-md text-slate-300 hover:text-green-400 hover:border-green-500/50 hover:bg-slate-800 transition-all duration-300 cursor-default"
                        >
              ...
              <div className="flex items-center gap-2 mt-8 pt-4 border-t border-slate-700/30">
                <span className="text-green-400">➜</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            ...
            <div className="bg-gradient-to-br from-orange-500/10 to-amber-500/10 border border-orange-500/20 rounded-xl p-4 text-center">
              ...
              <div className="text-sm text-slate-400">Skills & Tools</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-slate-900/70 to-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl overflow-hidden">
            <div className="grid md:grid-cols-2 gap-8 md:gap-12 p-8 md:p-10">
              ...
              <div className="md:col-span-1 flex flex-col items-center justify-start">
                <div className="relative group w-full h-[500px] md:h-[600px]">
                  ...
                  <div className="relative w-full h-full rounded-2xl overflow-hidden border-2 border-slate-700">
                    <img 
                      src="/mohit2.jpg" 
                      alt="Mohit Jain" 
                      className="w-full h-full object-cover"
                ...
                <div className="text-center mt-6">
                  <p className="text-slate-300 text-base">Mechanical Engineer turned</p>
                  <p className="text-blue-400 font-semibold text-lg">Full Stack Developer & AI Engineer</p>
                </div>
              </div>

              {/* Content Column */}
              <div className="md:col-span-1 space-y-5 text-slate-300 leading-relaxed">
                <div className="space-y-4">
                  ...
                  <p className="text-base">
                    My technical journey began with a <span className="text-slate-200 font-medium">B.E. in Mechanical Engineering from IET DAVV, India</span>, where I developed a strong foundation in problem-solving and systems thinking. During my undergraduate years, I was part of the <span className="text-cyan-400 font-medium">SAE Collegiate Club</span>, working in a 25-member team to design, fabricate, and test an all-terrain vehicle from scratch for the <span className="text-slate-200">SAE BAJA national competition</span>.
                  </p>
                  <p className="text-base">
                    My focus on optimization and component design led me to master CAD tools like <span className="text-slate-200">ANSYS and SolidWorks</span>. This experience with engineering software sparked a realization: <span className="text-blue-300 italic">software could be the ultimate tool for creation and innovation</span>.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-base">
                    During COVID-19, when industries shut down and my offer at FORCE Motors was put on hold, I made a pivotal decision: teach myself to code. Using online platforms like <span className="text-slate-200">Coursera and YouTube</span>, I dove into programming for the first time. What started as a productive use of time quickly became a passion.
                  </p>
                  <p className="text-base">
                    I joined <span className="text-blue-400 font-semibold">Accenture</span> where I spent <span className="text-cyan-400 font-semibold">2.5 years</span> building production systems. I progressed from <span className="text-slate-200">Associate to Analyst</span>, gaining hands-on experience with:
                  </p>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-base">
                    To gain a formal computer science foundation and deepen my expertise, I pursued an <span className="text-blue-400 font-semibold">M.S. in Software Engineering at Northeastern University</span>. This program allowed me to dive into advanced topics in AI, distributed systems, and software architecture.
                  </p>
                  <p className="text-base">
                    During my studies, I completed a <span className="text-purple-400 font-semibold">6-month co-op at TekLink International</span> as a Software Development Engineer Intern, where I:
                  </p>
                  <div className="space-y-2 pl-4">
                    <div className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-purple-400 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Built <span className="text-slate-200">RAG-based AI systems</span> for document analysis and chatbot applications</span>
                    </div>
                    <div className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-purple-400 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Developed full-stack platforms with <span className="text-slate-200">React, TypeScript, and FastAPI</span></span>
                    </div>
                    <div className="flex items-start gap-2">
                      <ChevronRight className="w-4 h-4 text-purple-400 mt-0.5 flex-shrink-0" />
                      <span className="text-sm">Established <span className="text-slate-200">CI/CD pipelines</span> and development best practices</span>
                    </div>
                  </div>
                  <p className="text-base">
                    I'm graduating in <span className="text-cyan-400 font-semibold">May 2026</span> and actively seeking full-time <span className="text-blue-400 font-semibold">Full Stack Developer & AI Engineer roles</span> where I can apply my unique blend of engineering problem-solving and modern software development skills.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="border-t border-slate-700/50 bg-slate-900/40 p-6">
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-slate-800/40 border border-blue-500/20 rounded-lg p-4 text-center hover:border-blue-500/40 transition-all">
                  <div className="text-2xl font-bold text-blue-400 mb-1">2.5 Years</div>
                  <div className="text-xs text-slate-400">Accenture • Full-Stack Development</div>
                  <div className="text-xs text-slate-500 mt-1">Mumbai, India</div>
                </div>
                <div className="bg-slate-800/40 border border-purple-500/20 rounded-lg p-4 text-center hover:border-purple-500/40 transition-all">
                  <div className="text-2xl font-bold text-purple-400 mb-1">6 Months</div>
                  <div className="text-xs text-slate-400">TekLink Co-op • AI Engineering</div>
                  <div className="text-xs text-slate-500 mt-1">Boston, MA</div>
                </div>
                <div className="bg-slate-800/40 border border-cyan-500/20 rounded-lg p-4 text-center hover:border-cyan-500/40 transition-all">
                  <div className="text-2xl font-bold text-cyan-400 mb-1">May 2026</div>
                  <div className="text-xs text-slate-400">MS Graduation • Northeastern</div>
                  <div className="text-xs text-slate-500 mt-1">Boston, MA</div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Chess */}
            <div className="group relative bg-gradient-to-br from-slate-900/80 to-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 hover:border-blue-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-blue-500/20 overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-start gap-2">
                    <ChevronRight className="w-5 h-5 text-blue-400 mt-0.5 flex-shrink-0" />
                    <span className="text-slate-300">Analytical thinking and strategic planning</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <ChevronRight className="w-5 h-5 text-blue-400 mt-0.5 flex-shrink-0" />
                    <span className="text-slate-300">Pattern recognition and problem decomposition</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <ChevronRight className="w-5 h-5 text-blue-400 mt-0.5 flex-shrink-0" />
                    <span className="text-slate-300">Decision making under time constraints</span>
                  </div>
                </div>
            ...
            {/* Photography */}
            <div className="group relative bg-gradient-to-br from-slate-900/80 to-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-8 hover:border-purple-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/20 overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-start gap-2">
                    ...
                    <span className="text-slate-300">Attention to detail and composition</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <ChevronRight className="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0" />
                    <span className="text-slate-300">Creative problem-solving and visual thinking</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <ChevronRight className="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0" />
                    <span className="text-slate-300">Patience and persistence for the perfect shot</span>
                  </div>
                </div>

                <div className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600/20 to-pink-600/20 border border-purple-500/30 rounded-lg text-purple-300">
      ...
      <section id="contact" className="py-20 px-6 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-br from-slate-900/80 to-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-3xl p-12 hover:border-blue-500/50 transition-all duration-500">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <a href="mailto:jain.mohi@northeastern.edu" className="group flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg hover:shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 hover:scale-105">
                <Mail className="w-5 h-5 group-hover:rotate-12 transition-transform" />
                Email Me
              </a>
              <a href="https://linkedin.com/in/mohit-jain-3008" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 px-8 py-4 border border-slate-600 rounded-lg hover:border-blue-500 hover:bg-blue-500/10 transition-all duration-300 backdrop-blur-sm">
                <Linkedin className="w-5 h-5 group-hover:rotate-12 transition-transform" />
                LinkedIn
              </a>
              <a href="https://github.com/mhitjain" target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 px-8 py-4 border border-slate-600 rounded-lg hover:border-purple-500 hover:bg-purple-500/10 transition-all duration-300 backdrop-blur-sm">
      ...
      <footer className="py-8 text-center text-slate-500 border-t border-slate-800 relative z-10">
        <p className="font-mono text-sm">
          <span className="text-blue-400">const</span> portfolio = <span className="text-purple-400">"Built with ❤️ using React & Tailwind CSS"</span>
        </p>
